...
async function fetchInitialProgram() {
  if (localStorage.getItem("weeklyProgram")) return;
...
function clearAll() {
  if (confirm("Vuoi davvero cancellare tutte le schede locali?")) {
